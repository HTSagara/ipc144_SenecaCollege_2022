...
// ToDo:
#define MAX_APPOINMENTS 15
#define FIRST_APPOINTMENT 10
#define LAST_APPOINMENT 14
#define CONSULT_LENGTH 30
...
// Todo:
void addAppointment(struct ClinicData* appointment, struct ClinicData* maxAppointments,
...
//Find date index------------------------------------------------------------------------------------------------------------------------------------------------------------------
int findAppointmentIndexByDate(struct Appointment appointments[], int year, int month, int day);
